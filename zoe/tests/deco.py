...
class DecoTest(TestCase):
    ...
    def test_catch2(self):
        class TestAgent:
            ...
            @zoe.Catch()
            def a(self, intent):
                TestAgent.acalled = True

            @zoe.Intent('b')
            def b(self, intent):
                TestAgent.bcalled = True
                return {'blip': 'blop'}
        ...
        self.assertFalse(TestAgent.bcalled)
        self._run(TestAgent, expected2)
        self.assertTrue(TestAgent.acalled)
